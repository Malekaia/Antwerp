...
use crate::antwerp::{Antwerp, Asset, Config, Lib, Post, Route, Template};
use tera::Context;
...
pub fn build() {
  ...
  config.routes = vec![
    Route::Page("404.tera", "404.html", Context::new()),
    Route::Page("index.tera", "index.html", {
    ...
    Route::Page("articles/index.tera", "articles/index.html", Context::new()),
  ];
  ...
  config.route_groups = vec![
    Route::Group("301.tera", {
      ...
      vec![
        Template { output: "articles/Bootstrap/how_to_change_the_default_font_in_bootstrap/index.html", context: context_301("/articles/CSS/how-to-change-the-default-font-in-bootstrap.html") },
        Template { output: "articles/Git/how_to_avoid_overusing_the_git_keyword/index.html", context: context_301("/articles/Git/how-to-avoid-retyping-the-git-keyword.html") },
        Template { output: "articles/Go/globbing_in_go/index.html", context: context_301("/articles/Go Lang/globbing-in-go.html") },
        Template { output: "articles/HTML/how_to_open_html_links_in_new_tabs/index.html", context: context_301("/articles/HTML/how-to-open-html-links-in-new-tabs.html") },
        Template { output: "articles/Node.js/environment_detection_in_javascript/index.html", context: context_301("/articles/JavaScript/environment-detection-in-javascript.html") },
        Template { output: "articles/Perl/how_to_unzip_an_archive_using_perl/index.html", context: context_301("/articles/Perl/how-to-call-a-subprocess-in-perl.html") },
        Template { output: "articles/Pip/an_introduction_to_the_pip_package_manager/index.html", context: context_301("/articles/Python/an-introduction-to-the-pip-package-manager.html") },
        Template { output: "articles/SASS/how_to_extend_parent_selectors_in_sass/index.html", context: context_301("/articles/CSS/how-to-extend-parent-selectors-in-sass.html") },
        Template { output: "articles/Web_Development/how_to_create_a_development_server_using_http_server/index.html", context: context_301("/articles/Python/how-to-create-a-development-server-using-http-server.html") }
      ]
    }),
