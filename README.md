...
<span style="color:red!important">**Update**</span>: 6 days, 18 hours, 28 minutes and 13 seconds after the initial commit (on 11/07/2022 at 05:14:29), the first complete build was made using the Rust port of Antwerp! See the full working example at [src/test/logicalbranch.rs](https://github.com/LogicalBranch/Antwerp/blob/master/src/test/logicalbranch.rs).
