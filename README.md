...
## Demonstration:
The following [Antwerp.toml](https://github.com/Malekaia/Antwerp/blob/main/example/Antwerp.toml) config file ([version 0.2.3](https://crates.io/crates/antwerp/0.2.3)) was used to generate [malekaia.github.io](https://malekaia.github.io):
